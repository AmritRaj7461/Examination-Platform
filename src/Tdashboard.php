...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex w-full">
        <div class="max-w-6xl mx-auto mt-23 ml-0 px-4">
            ...
            <section class="mb-5">
                <h2 class="text-2xl font-semibold mb-4 text-gray-800">Published Tests</h2>
                <div class="grid md:grid-cols-4 gap-4 ">
                    <div class="bg-white shadow-lg rounded-lg p-4 hover:shadow-xl transition">
                        ...
                        <button class="mt-5 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">View Details</button>
                    </div>
            ...
            <section class="mb-8">
                <h2 class="text-2xl font-semibold mb-4 text-gray-800">Draft Tests</h2>
